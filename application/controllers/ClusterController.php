...
class ClusterController extends CI_Controller
{
	public $userId;
	public $data = array();
	...
	public function addOrUpdateCluster($objCluster)
	{
	...
	{
		// Check if this cluster is being used anywhere
		if ($this->cluster_model->fetchCountByClusterId($cluster_id)) {
			$this->session->set_flashdata('exception', 'This Cluster is being used with User');
			return;
		}
