...
class Message extends OrganisationController
{
	...
	public function index($sender_id = null)
	{
		...
		$this->renderView('organisation/messages/inbox', $this->data);
	}

	public function reply($receiver_id = null)
	{
		$this->session->set_userdata('receiver_id', $receiver_id);
		redirect('organisation/message/new_message');
	}
	...
	public function sent($receiver_id = null)
	{
		...
		$this->renderView('organisation/messages/sent', $this->data);
	}
	...
	public function inbox_information($id = null, $sender_id = null)
	{
		...
		$this->renderView('organisation/messages/inbox_information', $this->data);
	}
	...
	public function sent_information($id = null, $receiver_id = null)
	{
		...
		$this->renderView('organisation/messages/sent_information', $this->data);
	}
	...
	public function new_message()
	{
		...
		if ($this->form_validation->run() === true) {
			...
			$this->data['designation_list'] = UserRole::getCASRoleNamesAsArray();
			$this->data['user_list'] = $this->user_model->user_by_role_as_list_for_coordinator_nojson(null, $this->getUserId(), $this->org_id, $this->cluster_id);
			$this->renderView('organisation/messages/new_message', $this->data);
		}
	}
	...
	public function user_by_role()
	{
		...
		return $this->user_model->user_by_role_as_list_for_coordinator($user_role, $this->getUserId(), $this->getOrgId(), $this->cluster_id);
	}
}
