...
class Message extends Animator
{
	private $org_id;
	private $cluster_id;
	private $user_id;
...
//			'organisation_model'
	...
	public function index($sender_id = null)
	{
		...
		$this->renderView('animator/messages/inbox', $this->data);
	}
	...
	public function sent($receiver_id = null)
	{
		...
		$this->renderView('animator/messages/sent', $this->data);
	}
	...
	public function inbox_information($id = null, $sender_id = null)
	{
		...
		$this->renderView('animator/messages/inbox_information', $this->data);
	}
	...
	public function sent_information($id = null, $receiver_id = null)
	{
		...
		$this->renderView('animator/messages/sent_information', $this->data);
	}
	...
	public function new_message()
	{
		...
		if ($this->form_validation->run() === true) {
			...
			redirect('animator/message/new_message');
		} else {
