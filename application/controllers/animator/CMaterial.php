...
require(APPPATH . 'controllers/animator/MaterialController.php');
...
class CMaterial extends MaterialController
{
	...
	public function index()
	{
		...
		$this->renderView('animator/material/list', $this->data);
	}
	...
	public function view($mat_id = ''): void
	{
		...
		$this->renderView('animator/material/view', $this->data);
	}
...
//		$this->data['center_list'] = $this->centerModel->readCenterByClusterIdAsList($this->getClusterId());
		...
		if ($this->form_validation->run() === true) {
			...
			$this->renderView('animator/material/upload', $this->data);
		}
	}
	...
	private function handleUpdate(array $postData): void
	{
		...
		redirect('animator/cmaterial/edit/' . $postData['mat_id']);
	}
	...
	public function do_upload()
	{
		...
		if (($_SERVER['REQUEST_METHOD']) == "POST") {
			...
			$config['allowed_types'] = 'pdf|xls|ppt|pptx|doc|docx|word|mov|avi|mp4|mpa|flv|webm|jpg|jpeg|jpe|png';
			$config['max_size'] = 0;
			$config['max_width'] = 0;
			$config['max_height'] = 0;
