...
<div class="row">
	<div class="col-sm-12">
		<?php echo form_open_multipart('animator/stakeholder/processStudentForm', 'class="form-inner" id=student_form') ?>
		<?php echo form_hidden('user_id', $student->user_id); ?>
		<div class="card card-outline card-primary">
			<div class="card-header">
				<h3 class="card-title"></h3>
				<div class="card-tools">
					<a class="btn btn-primary" href="<?php echo base_url("animator/stakeholder") ?>"> <i class="fa fa-list"></i> <?php echo display('list_student') ?> </a>
        </div>
			</div>
