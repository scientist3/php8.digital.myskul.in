...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url(); ?>" class="brand-link">
        <img src="<?php echo base_url('vendor/almasaeed2010/adminlte/'); ?>dist/img/AdminLTELogo.png"
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-compact" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('animator/cdashboard/index') ?>"
                       class="nav-link <?php echo $dashboard ?? null; ?>">
                ...
                <li class="nav-item <?php echo $material_menu ?? null; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cmaterial/create") ?>"
                               class="nav-link <?php echo $material_add_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo display('add_material'); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cmaterial/index") ?>"
                               class="nav-link <?php echo $material_view_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item <?php echo $activities_menu ?? null; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cactivities/studentSessionListing") ?>"
                               class="nav-link <?php echo $std_sess_comp_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cactivities/studentCncpListing") ?>"
                               class="nav-link <?php echo $cncp_enrolled_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cactivities/studentCncpSupportedListing") ?>"
                               class="nav-link <?php echo $cncp_supported_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cactivities/studentPsychoEducatedListing") ?>"
                               class="nav-link <?php echo $psycho_educated_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cactivities/studentPrimaryCounsellingListing") ?>"
                               class="nav-link <?php echo $primary_counselling_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cactivities/studentPsychoSocialWellBeingListing") ?>"
                               class="nav-link <?php echo $psycho_social_well_being_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cactivities/studentCarePlanListing") ?>"
                               class="nav-link <?php echo $care_plans_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item <?php echo $stakeholder_menu ?? null; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cstakeholder/processStakeholderForm") ?>"
                               class="nav-link <?php echo $add_stakeholders ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo display('add_stakeholders'); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cstakeholder/index") ?>"
                ...
                <li class="nav-item <?php echo $user_menu ?? null; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cstudent/processStudentForm") ?>"
                               class="nav-link <?php echo $user_add_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo display('add_student'); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/cstudent/index") ?>"
                               class="nav-link <?php echo $user_list_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item <?php echo $message_menu ?? null; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/message/new_message") ?>"
                               class="nav-link <?php echo $new_message_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo display('new_message'); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/message/index") ?>"
                               class="nav-link <?php echo $inbox_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url("animator/message/sent") ?>"
                               class="nav-link <?php echo $sent_option ?? null; ?>">
                                <i class="far fa-circle nav-icon"></i>
