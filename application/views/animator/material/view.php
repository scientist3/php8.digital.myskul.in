...
<div class="row">
	<div class="col-md-12">
		<a class="btn btn-primary float-right" href="<?php echo base_url("animator/cmaterial") ?>"> <i class="fa fa-chevron-left"></i> <?php echo display('view_material') ?> </a>
	</div>
	<div class="col-md-12">
		<!-- The time line -->
		<div class="timeline">
				...
				<div>
					...
					<div class="timeline-item">
						...
						<div class="timeline-footer">
							...
							<a class="btn btn-primary btn-sm " href="<?php echo base_url(); ?>animator/cmaterial/download/<?php echo $material->mat_id ?>"> <i class="fa fa-download"></i></a>
