<div class="row">
	<div class="col-md-3">
		<a href="<?php echo base_url("organisation/message/index") ?>" class="btn btn-primary btn-block mb-3"><?php echo display('back_to_inbox') ?></a>
				...
				<ul class="nav nav-pills flex-column">
					<li class="nav-item ">
						<a href="<?php echo base_url("organisation/message/index") ?>" class="nav-link <?php echo $inbox_option ?? null; ?>">
							...
							<span class="badge bg-primary float-right"><?php //echo count($messages);
																													?></span>
						</a>
					</li>
					<li class="nav-item ">
		...
		<div class="card card-primary card-outline">
			...
			<div class="card-body p-0">
				<div class="mailbox-read-info">
					...
					<h6>From: <?php echo $message->sender_name ?>
						<span class="mailbox-read-time float-right"><?php echo date('d M. Y h:i A', strtotime($message->datetime)) ?></span>
					</h6>
				</div>
				<!-- /.mailbox-read-info -->
