<div class="row">
	<div class="col-md-3">
		<a href="<?php echo base_url("organisation/message/new_message") ?>" class="btn btn-primary btn-block mb-3"><?php echo display('new_message') ?></a>
								...
								<?php foreach ($received_emails as $message) { ?>
									<tr>
										...
										<td class="mailbox-name">
											...
											<a href="<?php echo base_url("organisation/message/inbox_information/$message->id/$message->sender_id") ?>">
