<?php $this->load->view('organisation/layout/parts/header');?>
	<div class="wrapper">
		<!-- Navbar -->
		<?php $this->load->view('organisation/layout/parts/navbar');?>
		<!-- /.navbar -->

		<!-- Main Sidebar Container -->
		<?php $this->load->view('organisation/layout/parts/sidebar');?>
		...
		<!-- Footer -->
		<?php $this->load->view('organisation/layout/parts/footer');?>
		<!-- Control Sidebar -->
	...
	<!-- ./wrapper -->
	<!-- Scripts & End -->
<?php $this->load->view('organisation/layout/parts/scripts');?>