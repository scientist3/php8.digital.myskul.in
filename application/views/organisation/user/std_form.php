        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    ...
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_org/user/create_member") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_member') ?> </a>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_org/user/create_student','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="cluster_idd" class="col-xs-3 col-form-label"><?php echo display('cluster') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                   <?php
                                        echo form_dropdown('cluster_idd', $cluster_list, $student->cluster_idd, 'class="form-control" id="cluster_idd" '); 
                                    ?>
                            ...
                            <?php if ($student->center_id) { ?>
                                <div class="form-group row">
                                    <label for="center_id" class="col-xs-3 col-form-label"><?php echo display('center_name') ?> <i class="text-danger">*</i></label>
                                    <div class="col-xs-9">
                            ...
                            <?php }else{ ?>
                                <div class="form-group row">
                                    <label for="center_id" class="col-xs-3 col-form-label"><?php echo display('center_name') ?> <i class="text-danger">*</i></label>
                                    <div class="col-xs-9">
                                        <?php echo form_dropdown('center_id','','','class="form-control" id="center_id"') ?>
                                        <!-- <div id="available_days"></div> -->
                                    </div>
                                </div>
                            <?php } ?>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3"><?php echo display('age') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        <label class="radio-inline">
                            ...
                            <div class="form-group row">
                                <label for="school_status" class="col-xs-3 col-form-label"><?php echo display('other') ?></label>
                                <div class="col-xs-9"> 
                                    <?php
                                        $school_status = array(
                                            ''   => display('select_option'),
...
$(function(){
    ...
    $("#cluster_idd").change(function(){
        ...
        var center_list = $('#center_id');
        
        $.ajax({
            url  : '<?= base_url('dashboard_org/user/center_by_cluster/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
