			...
			<div class="card-header">
				...
				<div class="card-tools">
					<ul class="nav nav-pills ml-auto">
						<li class="nav-item">
							<a class="btn btn-primary" href="<?php echo base_url("coordinator/cmaterial/create") ?>"> <i class="fa fa-plus"></i> <?php echo display('add_material') ?> </a>
						</li>
					</ul>
				</div>
			</div>
							...
							<?php foreach ($materials as $material) { ?>
								<tr>
									...
									<td class="center" width="80">
										...
										<a href="<?php echo base_url("coordinator/cmaterial/view/$material->mat_id") ?>" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>
										<a href="<?php echo base_url("coordinator/cmaterial/edit/$material->mat_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
										<a href="<?php echo base_url("coordinator/cmaterial/delete/$material->mat_id?isfile=" . (($material->mat_type == 2) ? 1 : 0) . "&file=$material->mat_doc_link") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								<?php $sl++; ?>
							<?php } ?>
