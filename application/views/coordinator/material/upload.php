...
<div class="row">
	...
	<div class="col-sm-12">
		<div class="card card-outline card-primary">
			<div class="card-header">
				...
				<div class="card-tools">
					<ul class="nav nav-pills ml-auto">
						<li class="nav-item">
							<a class="btn btn-primary" href="<?php echo base_url("coordinator/cmaterial") ?>"> <i class="fa fa-list"></i> <?php echo display('view_material') ?> </a>
						</li>
					</ul>
				</div>
			</div>
			...
			?>
			<?php echo form_open_multipart('coordinator/cmaterial/create', 'class="form-inner" id="mailForm"') ?>
...
<script type="text/javascript">
	...
	$(function() {
		...
		browseFile.on('change', function(e) {
			...
			$.ajax({
				url: '<?php echo base_url('coordinator/cmaterial/do_upload') ?>',
		...
		$("#cluster_idd").change(function() {
			...
			$.ajax({
				url: '<?= base_url('coordinator/cmaterial/center_by_cluster/') ?>',
				type: 'post',
				dataType: 'JSON',
				data: {
