						...
						<div class="row">
							...
							<div class="col-sm-9">
								<dl class="dl-horizontal">
									<dt><?php echo display('student_id') ?></dt>
									<dd><?php echo $student->user_id ?></dd>
									<dt><?php echo display('firstname') ?></dt>
									<dd><?php echo $student->firstname ?></dd>
									<dt><?php echo display('mobile') ?></dt>
									<dd><?php echo $student->mobile ?></dd>
									<dt><?php echo display('email') ?></dt>
									<dd><?php echo $student->email ?></dd>
									<dt><?php echo display('district') ?></dt>
									<dd><?php echo $student->district ?></dd>
									<dt><?php echo display('block') ?></dt>
									<dd><?php echo $student->block ?></dd>
									<dt><?php echo display('village') ?></dt>
									<dd><?php echo $student->village ?></dd>
									<dt><?php echo display('school_type') ?></dt>
									<dd><?php echo $student->school_type ?></dd>
									<dt><?php echo display('school_level') ?></dt>
									<dd><?php echo $student->school_level ?></dd>
									<dt><?php echo display('school_name') ?></dt>
									<dd><?php echo $student->school_name ?></dd>
									<dt><?php echo display('sex') ?></dt>
									<dd><?php echo $student->sex ?></dd>
									<dt><?php echo display('age') ?></dt>
									<dd><?php echo $student->age ?></dd>
									<dt><?php echo display('class') ?></dt>
									<dd><?php echo $student->class ?></dd>
									<dt><?php echo display('school_status') ?></dt>
									<dd><?php echo $student->school_status ?></dd>
									<dt><?php echo display('father_name') ?></dt>
									<dd><?php echo $student->father_name ?></dd>
									<dt><?php echo display('father_occup') ?></dt>
									<dd><?php echo $student->father_occup ?></dd>
									<dt><?php echo display('mother_name') ?></dt>
									<dd><?php echo $student->mother_name ?></dd>
									<dt><?php echo display('mother_occup') ?></dt>
									<dd><?php echo $student->mother_occup ?></dd>
									<dt><?php echo display('create_date') ?></dt>
									<dd><?php echo $student->create_date ?></dd>
