...
<div class="row">
	<div class="col-sm-12">
		<?php echo form_open_multipart('coordinator/cstudent/processStudentForm', 'class="form-inner" id=student_form') ?>
		<?php echo form_hidden('user_id', $student->user_id); ?>
		<div class="card card-outline card-primary">
			<div class="card-header">
				<h3 class="card-title"></h3>
				<div class="card-tools">
					<a class="btn btn-primary" href="<?php echo base_url("coordinator/cstudent") ?>"> <i class="fa fa-list"></i> <?php echo display('list_student') ?> </a>
					<a class="btn btn-success" href="<?php echo base_url("coordinator/cuser/addUser") ?>"> <i class="fa fa-plus"></i> <?php echo display('add_member') ?> </a>
					<a class="btn btn-success" href="<?php echo base_url("coordinator/cuser/index") ?>"> <i class="fa fa-list"></i> <?php echo display('list_user') ?> </a>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		StudentFormModule.uploadFileUrl = "<?php echo base_url('coordinator/cstudent/handlePictureUpload') ?>";
		StudentFormModule.centerUrl = "<?= base_url('coordinator/cstudent/center_by_cluster/') ?>" ;
