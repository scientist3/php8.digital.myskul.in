...
<script type="text/javascript">
	$(document).ready(function() {
			...
			userTable.DataTable({
				...
				columns: [
					...
					},
					{
						...
						render: function(data, type, row) {
							// Customize the content of the cell
							var viewLink = '<?php echo base_url("coordinator/cstudent/profile/") ?>' + data;
							var editLink = '<?php echo base_url("coordinator/cstudent/edit/") ?>' + data;
							var deleteLink = '<?php echo base_url("coordinator/cstudent/stddelete/") ?>' + data;
		...
		function fetchCenterOptions(clusterIdValue) {
			$.ajax({
				url: "<?php echo site_url('coordinator/cstudent/center_by_cluster/') ?>",
				type: 'post',
				dataType: 'json',
				data: {
