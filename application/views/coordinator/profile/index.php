...
<div class="row">
	...
	<!-- Right Side -->
	<div class="col-md-9">
		<?php echo form_open_multipart('coordinator/cprofile/saveProfile/', 'class="form-horizontal" id="js-profile-form"') ?>
		<?php echo form_hidden('user_id', $user->user_id) ?>
		<div class="card card-primary card-outline">
			<div class="card-header p-2">
				<ul class="nav nav-pills">
					<li class="nav-item d-none"><a class="nav-link" href="#details" data-toggle="tab">Details</a></li>
				...
				<div class="tab-content">
					...
					<div class="active tab-pane" id="settings">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input name="firstname" type="text" class="form-control" id="firstname" placeholder="Name" value="<?php echo $user->firstname ?>" readonly>
							</div>
						</div>
						<!-- Email Id-->
						<div class="form-group row">
