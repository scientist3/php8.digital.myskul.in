...
<div class="row">
	<!--  form area -->
	<div class="col-sm-12">
		<?php echo form_open_multipart('coordinator/message/new_message/', 'class="form-inner" id="message_form"') ?>
		<div class="card card-outline card-primary">
			<div class="card-header">
				<h3 class="card-title"><i class="fa fa-edit"></i> <?php echo display('new_message'); ?></h3>
				<div class="card-tools">
					<a class="btn btn-primary" href="<?php echo base_url("coordinator/message") ?>"> <i class="fa fa-inbox"></i> <?php echo display('inbox') ?> </a>
					<a class="btn btn-info" href="<?php echo base_url("coordinator/message/sent") ?>"> <i class="fa fa-share"></i> <?php echo display('sent') ?> </a>
				</div>
			</div>
			<div class="card-body">
...
<script type="text/javascript">
	$(function() {
		...
		$('#user_role').on('select2:select', function(event) {
			...
			$.ajax({
				url: '<?= base_url('coordinator/message/user_by_role/') ?>', // Replace with the actual URL
		...
		$("#user_role1").change(function() {
			...
			$.ajax({
				url: '<?= base_url('coordinator/message/user_by_role/') ?>',
				type: 'post',
				dataType: 'JSON',
				data: {
