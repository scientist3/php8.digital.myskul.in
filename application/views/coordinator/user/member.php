		...
		<div class="card card-outline card-primary">
			<div class="card-header">
				...
				<div class="card-tools">
					<a class="btn btn-success" href="<?php echo base_url("coordinator/cuser/addUser") ?>">
						<i class="fa fa-user-plus"></i>&nbsp;&nbsp;<?php echo display('add_member') ?>
					</a>
					<a class="btn btn-info" href="<?php echo base_url("coordinator/cstudent/processStudentForm") ?>">
						<i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo display('add_student') ?>
					</a>
					<a class="btn btn-info" href="<?php echo base_url("coordinator/cstudent/index") ?>">
							...
							<?php foreach ($users as $user) { ?>
								<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
									...
									<td style="width:90px !important;">
										<a href="<?php echo base_url("coordinator/cuser/viewUserProfile/$user->user_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
										<a href="<?php echo base_url("coordinator/cuser/editUser/$user->user_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
										<a href="<?php echo base_url("coordinator/cuser/deleteUser/$user->user_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								<?php $sl++; ?>
							<?php } ?>
