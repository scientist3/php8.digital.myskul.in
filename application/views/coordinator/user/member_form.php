...
<div class="row">
	<div class="col-sm-12">
		<?php echo form_open_multipart('coordinator/cuser/addUser', 'class="form-inner" id="user_form"') ?>
		...
		<div class="card card-outline card-primary">
			<div class="card-header">
				...
				<div class="card-tools">
					<a class="btn btn-success" href="<?php echo base_url("coordinator/cuser/index") ?>">
						<i class="fa fa-list"></i> <?php echo display('list_user') ?>
					</a>
					<a class="btn btn-primary" href="<?php echo base_url("coordinator/cstudent/processStudentForm") ?>">
						<i class="fa fa-plus"></i> <?php echo display('add_student') ?>
					</a>
					<a class="btn btn-primary" href="<?php echo base_url("coordinator/cstudent/index") ?>">
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-4">
								<div class="form-group">
									...
									<?php echo form_dropdown('user_role', $designation_list, Userrole1::ANIMATOR, 'class="form-control" id="user_role" '); ?>
							...
							<div class="col-sm-6 col-md-4">
								<div class="form-group">
									...
									<?php echo form_dropdown('cluster_idd', $cluster_list, $student->cluster_idd, 'class="form-control" id="cluster_idd" disabled'); ?>
...
<script type="text/javascript">
	$(function() {
		...
		function uploadFile(uploadData) {
			$.ajax({
				url: '<?php echo base_url('coordinator/cuser/handlePictureUpload') ?>',
