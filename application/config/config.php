...
$config['sess_driver'] = 'database'; // Use the database session driver
$config['sess_save_path'] = 'ci_sessions'; // Table name to store sessions
$config['sess_time_to_update'] = 2000; // Regenerate session ID every 5 minutes
